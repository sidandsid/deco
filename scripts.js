...
jQuery(document).ready(function(){
    ...
    var headerMenu = jQuery('.js-header-menu'),
        headerMenuNav = jQuery('.js-header-menu__nav'),
        headerBurger = jQuery('.js-header-menu__burger-line');
    
    jQuery(headerMenu).on('click', function(){
    
        jQuery(headerMenuNav).toggleClass('active');
        jQuery(headerBurger).toggleClass('clicked');
    
        jQuery(document).on('click', function(i){
            if(jQuery(i.target).is(jQuery(headerMenu)) === false){
                jQuery(headerMenuNav).removeClass('active');
                jQuery(headerBurger).removeClass('clicked');
            }
        });
    });
    ...
    //init slider for Banner recent posts menu
    var bannerSlider = jQuery('.js-banner-slider__list').flickity({
        cellSelector: '.js-banner-slider__list li',
        cellAlign: 'left',
        initialIndex: 0,
        pageDots: true,
        prevNextButtons: true,
        wrapAround: true,
        arrowShape: 'm 66.84038,25.397957 c -0.242911,0.631734 -0.777314,1.091177 -1.408882,1.091177 H 54.549095 v 71.673094 c 0,1.033747 -0.68015,1.837772 -1.554629,1.837772 h -9.327774 c -0.874479,0 -1.554629,-0.804025 -1.554629,-1.837772 V 26.489134 H 31.229659 c -0.631568,0 -1.165971,-0.402013 -1.408882,-1.091177 -0.242911,-0.689165 -0.145747,-1.435759 0.242911,-2.010063 L 47.067443,1.3346342 c 0.291493,-0.34458216 0.68015,-0.57430362 1.117389,-0.57430362 v 0 c 0.43724,0 0.874479,0.22972146 1.165972,0.57430362 L 66.597469,23.387894 c 0.388658,0.574304 0.485822,1.320898 0.242911,2.010063 z'
    });
    //init slider for Sidebar slider widget
    var sidebarSlider = jQuery('.js-sidebar-slider .widget_media_gallery div').flickity({
